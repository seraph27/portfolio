...
To start, why should you care? Because as much as people want to cope <img src={copiumImg.src} alt="copium" class="inline h-5 w-5 align-middle" />
and say that companies are moving away from Leetcode style interviews...

![Reddit posts about companies moving away from LC interviews](./reddit_cope.png)

They're not. Aside from Meta and Stripe and a few companies that's "experimenting" with non-lc interviews. 
...
2. **It's relevant** — One common argument is that Leetcode is utterly "irrelevant" to any SWE job and it's a waste of time. This is just untrue. Ask yourself why top quant companies, AI labs, and big tech hire specifically ICPC or IOI medalists. 
So why are companies hiring people who spend thousands of hours in arbitary puzzles if it has "nothing" to do with 
the job? Maybe because it does has something to do with the job.

3. **Merit** — If you don't conduct DSA interviews, you're essentially asking companies to hire only from top universities.
That's even more gatekeeping. I've had many friends who couldn't afford top unis but still got good SWE positions due to being strong at DSA.

4. **"Real-life" interviews aren't easier** — People who think they'll magically pass non-LC interviews if companies switch to 
"real-life" work are delusional. If they give you AI assistance and web search, that's an **even stronger demand on fundamentals**. 
You'd be expected to know more: operating systems, networking, multiple languages deeply, system design, all that shit. It's not easier. 

</Callout>

I'm not suggesting that such interviews don't have it's flaws. Of course it does. But there has to be a compromise, and I think it's much easier
to prepare for than the alternative people are pushing for (the so-called "real-life" work and take home projects).

The reason why most people struggle with Leetcode, is simply because they're approaching it wrong. This is not me coming from a high horse. There is
a stark difference between what top problems solvers are doing, and what the average "advice" suggest people to do, from random 
people on the internet. I believe that
if you learn from shit people, you'll be shit. I'm not strong, so I'm not going to come up with advice. Instead, this blog will 
be a compilation of tips and resources from everything I've learned within my limited experience, from IOI medalists and ICPC finalists, LGMs on codeforces,
and all my friends that are stronger than me.  

## Misconceptions
//guide claude what to write here, delete this comment when after u fix: 
// 1. say u dont need an insane effort show my progress first (also write like my style) so proof of certificate. show my leetcode and cf profiles. put them in callouts
