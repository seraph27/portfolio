---
title: "Solutions"
description: "Code and approaches for the contest problems."
date: 2025-11-23
authors: ["seraph"]
---

[View Contest Problems (PDF)](/blog/beta/contest-Post-SCICPC-2025-2026.pdf)

### Problem A

```cpp title="problem/a.cpp" collapse={2-15}
#include <bits/stdc++.h>
using namespace std;
...
```cpp title="problem/b.cpp" collapse={2-15}
#include <bits/stdc++.h>
using namespace std;
...
```cpp title="problem/c.cpp" collapse={2-15}
#include <bits/stdc++.h>
using namespace std;
...
```cpp title="problem/d.cpp" collapse={2-15}
#include <bits/stdc++.h>
using namespace std;
...
```cpp title="problem/e.cpp" collapse={2-16}
#include <bits/stdc++.h>
using namespace std;
...
```cpp title="problem/f.cpp" collapse={2-15}
#include <bits/stdc++.h>
using namespace std;
...
```cpp title="problem/g.cpp" collapse={2-15}
#include <bits/stdc++.h>
using namespace std;
...
```cpp title="problem/h.cpp" collapse={2-15}
#include <bits/stdc++.h>
using namespace std;
...
```cpp title="problem/i.cpp" collapse={2-15}
#include <bits/stdc++.h>
using namespace std;
...
```cpp title="problem/j.cpp" collapse={2-15}
#include <bits/stdc++.h>
using namespace std;
...
```cpp title="problem/k.cpp" collapse={2-20}
...
```cpp title="problem/l.cpp" collapse={2-15}
#include <bits/stdc++.h>
using namespace std;
...
```cpp title="problem/m.cpp" collapse={2-15}
#include <bits/stdc++.h>
using namespace std;
